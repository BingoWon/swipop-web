...
export default function ProjectPage({
	...
	const isLiked = useInteractionStore((s) =>
		project ? s.isLiked(project.id) : false,
	);
	const likeCount = useInteractionStore((s) =>
		project ? s.likeCount(project.id) : 0,
	);
