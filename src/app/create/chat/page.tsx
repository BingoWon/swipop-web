...
export default function ChatPage() {
    const { messages, addMessage, setHtmlContent, setCssContent, setJsContent } = useCreate();
        ...
        <div className="flex flex-col h-full">
                ...
                {messages.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-full text-center">
                        ...
                        <p className="text-default-500 max-w-md">
                            Describe what you want to build and I'll generate the HTML, CSS, and JavaScript for you.
                        </p>
                    </div>
                ) : (
                    messages.map((msg) => (
            ...
            <div className="border-t border-divider p-4 space-y-3">
                ...
                <p className="text-tiny text-default-400 text-center">
                    Swipop AI can make mistakes. Review the generated code before publishing.
                </p>
            </div>
        </div>
    );
