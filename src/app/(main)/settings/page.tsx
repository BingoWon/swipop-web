		...
		<>
			...
			<Modal isOpen={logoutModal.isOpen} onClose={logoutModal.onClose}>
				<ModalContent>
					...
					<ModalFooter>
						<Button variant="light" onPress={logoutModal.onClose}>
							Cancel
						</Button>
						<Button
							color="danger"
				...
				<ModalContent>
					...
					<ModalBody>
						<p>
							...
							including projects, likes, and comments will be permanently
							deleted.
						</p>
						<p className="text-small text-default-500 mt-2">
							If you're sure, please contact support to proceed with account
							deletion.
						</p>
					</ModalBody>
					<ModalFooter>
