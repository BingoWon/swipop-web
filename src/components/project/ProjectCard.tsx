                ...
                >
                    {project.thumbnail_url ? (
                        ...
                        <div className="absolute inset-0 w-full h-full flex items-center justify-center bg-gradient-to-br from-primary/20 to-secondary/20">
                            <Icon icon="solar:code-bold" className="text-3xl text-default-400" />
                        </div>
                    )}
                </div>
                ...
                <div className="px-3 pt-2.5 pb-2">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="w-5 h-5 rounded-full bg-primary flex items-center justify-center flex-shrink-0">
                            <span className="text-[10px] font-bold text-white">{creatorInitial}</span>
                        </div>
                        ...
                        >
                            ...
                            />
                            <span className={`text-sm font-medium ${isLiked ? "text-danger" : "text-default-400"}`}>
