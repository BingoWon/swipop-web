...
export function ProfileHeader({ profile, isOwnProfile, onEditTapped }: ProfileHeaderProps) {
    return (
...
function ProfileProjectCell({ project, showDraftBadge, isOwnProfile }: ProfileProjectCellProps) {
